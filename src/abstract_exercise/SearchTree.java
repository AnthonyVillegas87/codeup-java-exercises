...
public class SearchTree implements NodeList{
    ...
    private void performRemoval(ListItem item, ListItem parent) {
        ...
        if (item.next() == null) {
            // no right tree, so make parent point to left tree (which could be null)
            if(parent.next() == item) {
            ...
            // no left tree, so make parent point to right tree (which could be null)
            if(parent.next() == item) {
                // item is right child of its parent
            ...
            if (leftmostParent == item) {
                ...
                // the smallest node's right child(which could be null)
